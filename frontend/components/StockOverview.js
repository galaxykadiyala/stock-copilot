    ...
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 h-full">
      ...
      <div className="mb-5">
        <div className="flex justify-between text-xs text-gray-400 mb-2">
          <span>52W Low: <span className="text-white font-medium">${low_52w ?? 'N/A'}</span></span>
          <span>52W High: <span className="text-white font-medium">${high_52w ?? 'N/A'}</span></span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-gray-800/60 rounded-lg p-3">
          ...
          <p className="text-white font-semibold">{formatMarketCap(market_cap)}</p>
        </div>
        <div className="bg-gray-800/60 rounded-lg p-3">
